...
const mall = {
    ...
    getMall: (options?: Options) => {
        return publicRequest.get<GetMallResponse>('malls', options);
    },
    ...
    getMallPartners: (options?: Options) => {
        return publicRequest.get<GetMallPartnersResponse>(
            'malls/partners',
            options,
        );
    },
    ...
    getSslInfo: (options?: Options) => {
        return publicRequest.get<GetSslInfoResponse>('malls/ssl', options);
    },
};
