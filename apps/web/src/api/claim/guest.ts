...
//     ) => {
//         return shopbyRequest.post('/guest/claims/cancel', {
//             json: data,
//             ...options,
//         });
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post<ClaimPriceInfo>('/guest/claims/estimate', {
//             json: data,
//             ...options,
//         });
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post('/guest/claims/return', {
//             json: data,
//             ...options,
//         });
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.put(`/guest/claims/${claimNo}/account`, {
//             json: data,
//             ...options,
//         });
//     },
...
//         return shopbyRequest.put(`/guest/claims/${claimNo}/withdraw`, options);
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post(`/guest/orders/${orderNo}/claims/cancel`, {
//             json: data,
//             ...options,
//         });
//     },
