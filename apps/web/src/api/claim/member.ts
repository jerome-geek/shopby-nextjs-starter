...
//     ) => {
//         return shopbyRequest.get<GetClaimListResponse>('profile/claims', {
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post('profile/claims/cancel', {
//             json: data,
//             ...options,
//         });
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post<ClaimPriceInfo>('profile/claims/estimate', {
//             json: data,
//             ...options,
//         });
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post('profile/claims/return', {
//             json: data,
//             ...options,
//         });
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.post<CheckFreeGiftSatisfyResponse>(
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.put(`profile/claims/${claimNo}/account`, {
//             json: data,
//             ...options,
//         });
//     },
...
//         return shopbyRequest.get<CheckWithdrawResponse>(
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.get<GetClaimDetailByClaimNoResponse>(
...
//         return shopbyRequest.put(`profile/claims/${claimNo}/withdraw`, options);
//     },
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.get<GetOrderOptionDetailForClaimResponse>(
...
//         options?: AxiosRequestConfig,
//     ) => {
//         return shopbyRequest.get<ClaimPriceInfo>(
