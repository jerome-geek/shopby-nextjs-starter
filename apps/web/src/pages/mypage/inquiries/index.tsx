...
import * as inquiryHeaderStyles from '@/components/mypage/inquiries/accordion-header/index.css';
                        ...
                        {isEmpty(inquiryList) ? (
                            ...
                            <ul>
                                {inquiryList.map((item) => (
                                    <li
                                        key={item.inquiryNo}
                                        className={styles.inquiryDesktopItem}
                                    >
                                        <div
                                            className={
                                                styles.inquiryDesktopSummary
                                            }
                                        >
                                            <div
                                                className={
                                                    styles.inquiryDesktopCell
                                                }
                                            >
                                                <span
                                                    className={clsx(
                                                        inquiryHeaderStyles.statusBadge,
                                                        item.answer
                                                            ? inquiryHeaderStyles.statusBadgeActive
                                                            : inquiryHeaderStyles.statusBadgeInactive,
                                                    )}
                                                >
                                                    {t(
                                                        item.answer
