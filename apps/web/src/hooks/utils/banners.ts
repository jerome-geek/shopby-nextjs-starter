 ...
 */
export const sortAccounts = (accounts: BannerAccount[]): BannerAccount[] =>
    pipe(
        accounts,
 ...
 */
export const getBannerContentList = (account: BannerAccount | null): Banner[] => {
    if (!account) {
        return [];
    }
 ...
 * 배너 링크 속성을 생성하는 함수
 */
export const toBannerLinkAttributes = (banner: Banner) => {
 ...
 */
export const splitBannersIntoTwoRows = (
    banners: Banner[],
