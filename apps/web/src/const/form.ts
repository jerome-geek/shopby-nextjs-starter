...
const MOBILE_COUNTRY_CODE_LIST = [
    {
        label: 'Andorra (+376)',
        value: 'AD',
    },
...
const CASH_RECEIPT_KEY_TYPE_LIST = [
    {
        label: '휴대폰번호',
        value: 'MOBILE_NO',
    },
...
export {
    ...
    COUNTRY_CODE_LIST,
    STATE_LIST,
    CASH_RECEIPT_KEY_TYPE_LIST,
    CASH_RECEIPT_RADIO_LIST,
};
