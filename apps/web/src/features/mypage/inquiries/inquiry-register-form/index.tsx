...
import * as styles from '@/features/mypage/inquiries/inquiry-register-form/index.css';
import { InquiryTypeList } from '@/features/mypage/inquiries/inquiry-type-list';
