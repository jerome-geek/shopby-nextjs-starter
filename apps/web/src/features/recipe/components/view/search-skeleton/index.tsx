import * as cardStyles from '@/features/recipe/components/view/card/index.css';
import * as detailCardStyles from '@/features/recipe/components/view/detail-card/index.css';
