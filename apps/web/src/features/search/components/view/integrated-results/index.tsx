...
import { CollectionRecommendSection } from '@/features/search/components/view/collection-recommend-section';
import * as collectionStyles from '@/features/search/components/view/collection-results/index.css';
import * as styles from '@/features/search/components/view/integrated-results/index.css';
import { RecipeRecommendSection } from '@/features/search/components/view/recipe-recommend-section';
import * as recipeStyles from '@/features/search/components/view/recipe-results/index.css';
import { ShoppingRecommendSection } from '@/features/search/components/view/shopping-recommend-section';
import { ShoppingRecommendSectionSkeleton } from '@/features/search/components/view/shopping-recommend-section/skeleton';
import * as shoppingStyles from '@/features/search/components/view/shopping-results/index.css';
