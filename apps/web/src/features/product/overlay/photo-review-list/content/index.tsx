...
import { PhotoReviewDetail } from '@/features/product/overlay/photo-review-list/content/detail';
import * as styles from '@/features/product/overlay/photo-review-list/content/index.css';
