...
import * as recipeDetailCardStyle from '@/features/recipe/components/view/detail-card/index.css';
import * as collectionSectionStyle from '@/features/section/components/collection-group/collection/index.css';
