...
import Products from '@/features/section/components/products/section';
import ProductsSectionSkeleton from '@/features/section/components/products/section/skeleton';
