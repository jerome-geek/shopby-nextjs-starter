...
vi.mock('@/components/order/shipping-address/index.css', () => ({
    container: 'container',
...
vi.mock('@/components/order/shipping-address/GuestShippingAddressForm', () => ({
    default: () => <div>guest-form</div>,
}));

vi.mock('@/components/order/shipping-address/MemberShippingAddressForm', () => ({
    default: () => <div>member-inline-form</div>,
}));

vi.mock('@/components/order/shipping-address/DeliveryRequestForm', () => ({
...
const renderWithForm = async (shippingAddress: PaymentReserveSchemaType['shippingAddress']) => {
    const { default: ShippingAddress } = await import(
        '@/components/order/shipping-address'
    );
