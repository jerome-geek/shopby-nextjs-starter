...
import * as styles from '@/components/banner/icon-banner-section/index.css';
...
const IconBannerSectionSkeleton = () => {
...
const IconBannerSectionContent = ({ type }: { type: HeroBannerType }) => {
...
const IconBannerSection = ({ type }: { type: HeroBannerType }) => {
    return (
        <Suspense fallback={<IconBannerSectionSkeleton />}>
            <IconBannerSectionContent type={type} />
        </Suspense>
    );
};
